...
### [4] [Closing the Long-Short View Gap in Sequential Recommendation without Cached History](https://arxiv.org/abs/2609.06219)
...
### [5] [Relevance is not enough: A Communication-Oriented Retrieval System for Consequential Scientific Question Answering](https://arxiv.org/abs/2609.06222)
...
### [6] [FunnelAudit: Responsibility Auditing in Multi-Route Recommender Systems](https://arxiv.org/abs/2609.06964)
...
### [7] [EAGER: Enrich-and-Align Generative Query Recommendation from Clicked Items in E-commerce Search](https://arxiv.org/abs/2609.07143)
...
### [8] [Query-Aware Token Budgeting for Efficient Late-Interaction Visual Document Retrieval](https://arxiv.org/abs/2609.07262)
...
### [9] [Task-Blind No MORE: Multi-Task Information Flow in Unified Ranking Backbones](https://arxiv.org/abs/2609.07273)
...
### [10] [Matryoshka Hash Representations for Model-Aware Compact Semantic Retrieval](https://arxiv.org/abs/2609.07276)
...
### [11] [EigenLI: Spectral Approximations to Late Interaction](https://arxiv.org/abs/2609.07561)
...
### [12] [Noēsis: Deterministic-First Retrieval with Two-Tier Context Hydration for Factuality-Critical Queries on Small Local Models](https://arxiv.org/abs/2609.07663)
*Nicola Cogotti*
...
### [13] [Cassette: Case-to-Case Structural Distillation for Efficient Legal Case Retrieval](https://arxiv.org/abs/2609.08185)
...
### [14] [SequenceO1: End-to-End Ultra-Long (100K) Sequence Modeling in Recommendation with Low-Rank Caching](https://arxiv.org/abs/2609.08443)
...
### [15] [PDMR: Passage-Driven Multi-ID Document Retrieval](https://arxiv.org/abs/2609.08762)
...
### [16] [REDSI: Addressing the Reproducibility and Evaluation Consistency of Differentiable Search Indexing for Document Retrieval](https://arxiv.org/abs/2609.08860)
...
### [17] [Q2D-Web: A Large-Scale Benchmark for Retrieval in Agentic RAG Systems](https://arxiv.org/abs/2609.08887)
...
### [18] [FINALLY: A Dataset Recommender System for Recommender-Systems Research](https://arxiv.org/abs/2609.08941)
*Louis Owie*
