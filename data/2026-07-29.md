...
### [1] [VLD-RAG: Agentic Vision-Language Retrieval-Augmented Generation for Long, Visually-Rich Multi-Page Documents](https://arxiv.org/abs/2607.24748)
*Seonok Kim*
...
### [2] [CHaystack: Benchmarking Chinese Document Retrieval and VQA](https://arxiv.org/abs/2607.24760)
*Hanxi Li*
...
### [3] [The Effect of Text Chunk Size on Retrieval-Augmented Generation Performance](https://arxiv.org/abs/2607.24767)
...
### [4] [JKO-RAG: Distributional Retrieval as Wasserstein Free-Energy Gradient Flow](https://arxiv.org/abs/2607.24776)
...
### [5] [Three Sides of Retrieval: Factorial Evidence for Document-Side, Query-Side, and Answer-Side Complementarity in RAG](https://arxiv.org/abs/2607.24781)
*Ng S. T. Chong*
...
### [6] [Unlocking Spatial Grounding in Large Audio-Visual Retrieval models](https://arxiv.org/abs/2607.24786)
...
### [7] [NEXT: Reasoning-Driven Video Recommendation via a Vision-Language Model](https://arxiv.org/abs/2607.24789)
...
### [8] [From Naive RAG to Deep Agentic Retrieval: An Evolving Context Engineering Pipeline for Regulatory Compliance](https://arxiv.org/abs/2607.24791)
...
### [9] [AI-Assisted Knowledge Access for Legacy Enterprise Asset Management in Energy Operations: A Practical Retrieval System](https://arxiv.org/abs/2607.24792)
...
### [10] [Retrieval, not hallucinations, will be the limiting factor for LLM-based clinical AI tools](https://arxiv.org/abs/2607.24793)
...
### [11] [Multimodal Hybrid Retrieval-Augmented Generation for Scientific Document Understanding using Open-Source SLMs](https://arxiv.org/abs/2607.24799)
...
### [12] [When Thinking Before Retrieval Hurts: TraceBound Diagnostics for Adaptive Knowledge-Graph Retrieval](https://arxiv.org/abs/2607.24800)
...
### [13] [SciClaimSeekers at CheckThat! 2026: Retrieving Scientific Sources for Social Media Claims with LLM Reranking](https://arxiv.org/abs/2607.24803)
...
### [14] [Bumblebee: Interleaved Mixed-Layer Building Blocks for Large-Scale Recommendation Systems](https://arxiv.org/abs/2607.24804)
...
### [15] [Retrieval-Augmented Generation in LLMs for Mental Health: Quantifying the Incremental Contribution of Retrieval Within a Layered Safety Architecture](https://arxiv.org/abs/2607.24817)
...
### [16] [A Position Paper on Recommender Systems in the Era of Autonomous Agents](https://arxiv.org/abs/2607.24822)
*Aixin Sun*
...
### [17] [Retrieval-based and Fine-tuned LLM Approaches for Industrial Asset Health Monitoring and Decision Support](https://arxiv.org/abs/2607.24824)
...
### [18] [Aethel: A Reproducible Graph-Retrieval Framework for Multi-Hop Financial Diligence](https://arxiv.org/abs/2607.24826)
*Krish Sapru*
...
### [19] [Improving Rare Medication Recommendation with Counterfactual Data Augmentation and Large Language Models](https://arxiv.org/abs/2607.24829)
...
### [20] [REPREC: Representation Driven Parameter-Efficient Recommendation System](https://arxiv.org/abs/2607.24845)
...
### [21] [Two Views, One Voice: Evidence-Grounded Conversational Music Recommendation](https://arxiv.org/abs/2607.24846)
...
### [22] [HVM-GraphRAG: Holistic-View Multimodal Graph Retrieval-Augmented Generation on Complex Document](https://arxiv.org/abs/2607.24861)
...
### [23] [KuaiLive-M3: A Multi-Modal, Multi-Domain, and Multi-Feedback Dataset for Live Streaming Recommendation](https://arxiv.org/abs/2607.24862)
...
### [24] [Tokens are All You Need: Dual-purpose Semantic IDs for Achieving LLM-Level I/O Efficiency in recommendation systems](https://arxiv.org/abs/2607.24865)
...
### [25] [Ranked by Position: Order Sensitivity as an Exploitable Attack Surface in LLM Listwise Recommenders](https://arxiv.org/abs/2607.24869)
...
### [26] [Agent Retrieval Bench: Evaluating Repository Context Retrieval for Coding Agents](https://arxiv.org/abs/2607.24882)
*Bowen Qin,Yi Xie*
...
### [27] [On the Convergent Validity of Offline Evaluation Designs for Recommender Systems](https://arxiv.org/abs/2607.25097)
...
### [28] [Memory Layer: Train the In-Model Cache for Recommendation Models](https://arxiv.org/abs/2607.25110)
...
### [29] [Bekko Embedding: Parameter-Efficient Multilingual Retrieval with Ultra-Compact Encoders](https://arxiv.org/abs/2607.25180)
*Yuichi Tateno*
...
### [30] [VaLiDRec: Variable-Length LLM-Aligned Semantic IDs for Generative Recommendation](https://arxiv.org/abs/2607.25209)
...
### [31] [TopoGR: Revealing and Preserving Latent Structure of Semantic ID in Generative Recommendation](https://arxiv.org/abs/2607.25216)
...
### [32] [Structure-aware Relative Policy Optimization for Ranking](https://arxiv.org/abs/2607.25268)
...
### [33] [Grevo: A Unified Generative Recommendation Framework with Evolutionary Item Indexing](https://arxiv.org/abs/2607.25329)
...
### [34] [SPARC: Sequence-aware Progressive Attribute Routing and Compression Framework for Generative Recommendation](https://arxiv.org/abs/2607.25339)
...
### [35] [Reward Guided Decoding for Generative Recommendation](https://arxiv.org/abs/2607.25344)
...
### [36] [The Case Against Generation for Retrieval: Discriminative Language Models as Effective Retrievers](https://arxiv.org/abs/2607.25346)
...
### [37] [Sharpness-aware Model Merging with Salience Recovery for LLM-based Cross-Domain Sequential Recommendation](https://arxiv.org/abs/2607.25366)
...
### [38] [MARS: Multi-Agent Re-ranking for Repeat-Order Food Delivery Recommendation](https://arxiv.org/abs/2607.25420)
...
### [39] [Beyond Self-Knowledge: Propagating Uncertainty Across Reasoning and Retrieval in LLMs](https://arxiv.org/abs/2607.25600)
...
### [40] [LLM-as-a-Judge for Evaluating System Responses in Conversational Music Recommendation](https://arxiv.org/abs/2607.25640)
...
### [41] [Hypothesis-Driven Shelf Generation for Personalised Recommendation](https://arxiv.org/abs/2607.25823)
...
### [42] [RecoReward: Recommender-Guided Multimodal Description Generation for Recommendation](https://arxiv.org/abs/2607.25901)
