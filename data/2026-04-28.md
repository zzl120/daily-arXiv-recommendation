...
### [2] [StratRAG: A Multi-Hop Retrieval Evaluation Dataset for Retrieval-Augmented Generation Systems](https://arxiv.org/abs/2604.22757)
*Aryan Patodiya*
...
### [3] [Beyond Static: Related Questions Retrieval Through Conversations in Community Question Answering](https://arxiv.org/abs/2604.22759)
...
### [4] [Quantifying Divergence in Inter-LLM Communication Through API Retrieval and Ranking](https://arxiv.org/abs/2604.22760)
*Eyhab Al-Masri*
...
### [5] [CS3: Efficient Online Capability Synergy for Two-Tower Recommendation](https://arxiv.org/abs/2604.22761)
...
### [6] [RCSB PDB AI Help Desk: retrieval-augmented generation for protein structure deposition support](https://arxiv.org/abs/2604.22800)
...
### [7] [Structure Guided Retrieval-Augmented Generation for Factual Queries](https://arxiv.org/abs/2604.22843)
...
### [8] [R$^3$AG: Retriever Routing for Retrieval-Augmented Generation](https://arxiv.org/abs/2604.22849)
...
### [9] [IntrAgent: An LLM Agent for Content-Grounded Information Retrieval through Literature Review](https://arxiv.org/abs/2604.22861)
...
### [10] [CASP: Support-Aware Offline Policy Selection for Two-Stage Recommender Systems](https://arxiv.org/abs/2604.23022)
*Nilson Chapagain*
...
### [11] [Adopting State-of-the-Art Pretrained Audio Representations for Music Recommender Systems](https://arxiv.org/abs/2604.23077)
...
### [12] [Birds of a Feather Cluster Nearby: a Proximity-Aware Geo-Codebook for Local Service Recommendation](https://arxiv.org/abs/2604.23156)
...
### [13] [Efficient Rationale-based Retrieval: On-policy Distillation from Generative Rerankers based on JEPA](https://arxiv.org/abs/2604.23336)
...
### [14] [A Parametric Memory Head for Continual Generative Retrieval](https://arxiv.org/abs/2604.23388)
...
### [15] [Lost in Decoding? Reproducing and Stress-Testing the Look-Ahead Prior in Generative Retrieval](https://arxiv.org/abs/2604.23396)
...
### [16] [Beyond Static Collision Handling: Adaptive Semantic ID Learning for Multimodal Recommendation at Industrial Scale](https://arxiv.org/abs/2604.23522)
...
### [17] [Green-Red Watermarking for Recommender Systems](https://arxiv.org/abs/2604.23568)
...
### [18] [Prompt-Unknown Promotion Attacks against LLM-based Sequential Recommender Systems](https://arxiv.org/abs/2604.23640)
...
### [19] [Prism-Reranker: Beyond Relevance Scoring -- Jointly Producing Contributions and Evidence for Agentic Retrieval](https://arxiv.org/abs/2604.23734)
*Dun Zhang*
...
### [20] [GLIER: Generative Legal Inference and Evidence Ranking for Legal Case Retrieval](https://arxiv.org/abs/2604.23779)
...
### [21] [S2G-RAG: Structured Sufficiency and Gap Judging for Iterative Retrieval-Augmented QA](https://arxiv.org/abs/2604.23783)
...
### [22] [Disagreement as Signals: Dual-view Calibration for Sequential Recommendation Denoising](https://arxiv.org/abs/2604.24048)
...
### [23] [Geometric Analysis of Self-Supervised Vision Representations for Semantic Image Retrieval](https://arxiv.org/abs/2604.24469)
...
### [24] [Modeling Behavioral Intensity and Transitions for Generative Recommendation](https://arxiv.org/abs/2604.24472)
...
### [25] [Learning to Route Queries to Heads for Attention-based Re-ranking with Large Language Models](https://arxiv.org/abs/2604.24608)
