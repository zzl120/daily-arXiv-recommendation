...
### [4] [DS@GT ARC at Touché: Large Language Models for Retrieval-Augmented Debate](https://arxiv.org/abs/2608.08143)
...
### [5] [Personalized Communication Skills for Agentic Recommender Systems](https://arxiv.org/abs/2608.08417)
...
### [6] [Structure-Preserving Projection for Mitigating Modality Bias in LLM-Based Sequential Recommendation](https://arxiv.org/abs/2608.08583)
...
### [7] [Difficulty-Gated Fusion of Reasoning Views for Temporal Retrieval](https://arxiv.org/abs/2608.08940)
...
### [8] [Guardian Crawler: Retrieval-First Knowledge Discovery with Bounded LLM Augmentation for Noisy Web Intelligence](https://arxiv.org/abs/2608.08994)
...
### [9] [PreGress: Ranking-Native Pre-training and Prompting for Graph Node Ranking](https://arxiv.org/abs/2608.09016)
...
### [10] [MetaStrategy: Generative Ranking with Executable LLM Strategies](https://arxiv.org/abs/2608.09440)
...
### [11] [TSPORec: Token Selection via Preference Optimization for LLM-Based Sequential Recommendation](https://arxiv.org/abs/2608.09605)
...
### [12] [IntHQ: Task-Interactive Hierarchical Query on Dual-Stream Representations for Generative Recommendation](https://arxiv.org/abs/2608.09634)
...
### [13] [Listwise Cross-Encoder Fine-Tuning vs. Agentic Instruction Tuning for LLM Rerankers: A Systematic Study in Medical Procedure Reranking](https://arxiv.org/abs/2608.09650)
